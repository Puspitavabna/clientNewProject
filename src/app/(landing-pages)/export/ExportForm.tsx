...
const ExportForm: React.FC<OrderProps> = ({ orderid }) => {
    ...
    <div>
      <div className="flex flex-col justify-between">
        ...
        <div className="flex-1">
          <h3 className="flex justify-center text-xl text-[#151B54]">Export</h3>
        </div>
        <div></div>
      </div>
      <div className="space-4 mt-10 grid w-[100%] grid-cols-1 gap-1 md:grid-cols-3">
        ...
        <fieldset className="mb-8 rounded-md border-2 border-[#151854] px-4 relative">
          ...
          <select
            ...
            onChange={handleChange}
            className="mt-1 block h-8 w-full rounded-lg border-none bg-[#D9D9D91A] outline-none"
          >
