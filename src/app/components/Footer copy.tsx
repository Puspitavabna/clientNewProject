...
export default function Footer() {
  ...
  return (
    ...
    //             onClick={link.name === "Contact Us" ? openContactModal : undefined}
    //           >
    //             {link.name}
    //           </FooterLink>
    //         ))}
    ...
    //           <UpdateConversation isOpen={isChatModalOpen} onClose={closeChatModal} />
    ...
    //     <div className="bg-[#F2EDE4] rounded-lg shadow-lg max-w-2xl w-full h-[580px] relative">
    //       {/* Close button */}
    //       {/* <button
    //         onClick={closeContactModal}
    //         className="text-black hover:text-gray-600 text-xl absolute top-4 right-4 "
    //       >
    //         x
    //       </button> */}
    ...
    //       <ContactForm />  {/* Your ContactUs component will be rendered here */}
    //       <button
    //         onClick={closeContactModal}
    //         className="text-black hover:text-gray-600 text-xl absolute top-4 right-4 "
    //       >
          ...
          <div className="z-70 fixed bottom-20 right-6 w-[570px] rounded-xl bg-[#ECEEF1] pb-4">
            ...
            <div className="mb-4 flex items-center gap-4 rounded-t-lg bg-[#FFB200F2] p-10">
              ...
              <h2 className="text-lg font-semibold">
                Hello, <br /> Welcome to our live chat! <br /> Hey! How can we
                help you today!
              </h2>
            </div>
...
//   return (
//     <form>
//       <select className="mr-4 rounded-lg border border-black px-3 py-2 w-auto" style={{ width: 'auto', minWidth: '10px' }}>
