      ...
      {slides.length > 1 && (
        <div className="mt-4 flex justify-start gap-x-4">
          <button
            ...
            className={`flex h-[16px] w-[28px] items-center justify-center rounded-s-3xl ${
              isLeftDisabled ? 'bg-gray-500' : 'bg-[#2C3539]'
            } text-[#151B54]`}
          ...
          <button
            ...
            className={`flex h-[16px] w-[28px] items-center justify-center rounded-e-3xl ${
              isRightDisabled ? 'bg-gray-500' : 'bg-[#2C3539]'
            } text-[#151B54]`}
